  ...
  <div class="row">
	 <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
	 	<div class="form-group">
	 		...
	 		<select name="tipo_comprobante" class="form-control">
	 			...
	 			<option value="Re-Liquidacion">Re-Liquidacion</option>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
		<div class="form-group">
			...
			<select name="idperiodoliquidacion" id="idperiodoliquidacion" class="form-control selectpicker" data-live-search="true">
			<option disabled="disabled" selected="selected">---Seleccione el Periodo---</option>	
			@foreach($periodos as $per)
				<option value="{{$per->idperiodoliquidacion}}">{{$per->Periodo}}</option>
			@endforeach
			</select>
		</div>
	</div>
	 ...
	 <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
		<div class="form-group">
			<label for="fecha_documento">Fecha Liquidación</label>
			<input type="date" name="fecha_documento" id="fecha_documento" required value="{{old('fecha_documento')}}" class="form-control">
		</div>
	</div>
	...
	<div class="panel panel-primary">
		<div class="panel-body">
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
				<div class="form-group">
					<label>Concepto</label>
				 		<select name="pidconcepto" id="pidconcepto" class="form-control" onchange="asignarValores();">
				 			<option disabled="disabled" selected="selected">---Concepto---</option>
				 			<option value="Concepto1">Concepto 1</option>
				 			<option value="Concepto2">Concepto 2</option>
				 			<option value="Concepto3">Concepto 3</option>
				 		</select>
				</div>
			</div>	
			...
			<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
				<div class="form-group">
					<label for="cant_tokens">Cantidad</label>
 					<input type="number" name="pcant_tokens" id="pcant_tokens" onkeyup="deshabilita()" class="form-control" placeholder="Cantidad...">
				</div>	
			</div>
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
				<div class="form-group">
					<label for="valor_tokens" >Valor</label>
 					<input type="number" name="pvalor_tokens" id="pvalor_tokens" onkeyup="deshabilita()" class="form-control" placeholder="Valor...">
				</div>	
			</div>

			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
				<div class="form-group">
					<label for="valor_dolares" >Valor USD</label>
 					<input type="number" name="pvalor_dolares" id="pvalor_dolares" onkeyup="deshabilita()" class="form-control" placeholder="Valor USD...">
				</div>	
			</div>
			...
			<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
				<div class="form-group">
					<label for="porc_liquidacion">%Pago</label>
 					<input type="number" name="pporc_liquidacion" id="pporc_liquidacion" onkeyup="deshabilita()" class="form-control" placeholder="%...">
				</div>	
			</div>
			...
			<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
				<div class="form-group">
					<label for="trm">TRM</label>
 					<input type="number" name="ptrm" id="ptrm" onkeyup="deshabilita()" class="form-control" placeholder="TRM Pago...">
				</div>	
			</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
					...
					<tfoot>
						...
						<th></th>	
						<th></th>
						<th><h4 id="total">US$ 0.00</h4><input type="hidden" name ="total_pago" id="total_pago"></th>
					</tfoot>
					<tbody>
					</tbody>
				</table>
